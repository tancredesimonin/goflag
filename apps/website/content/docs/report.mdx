...
```jsonc
{
  ...
  "localeAxis": { "locales": ["en", "fr", "de"], "source": "sitemap", "multilingual": true },
  ...
  "pages": [{ "url": "https://example.com/", "status": 200, "locale": null } /* … ×128 */],
  "unreachablePages": [],
  "brokenLinks": [/* 3 entries */],
  "missingTranslations": { "holes": [/* 2 entries */], "reciprocity": [] },
...
Pin the version you parse against.
