...
Nothing moved since the baseline — 13 findings still open. Run without --regressions-only to see them.
```
...
- [Look at the cards](/docs/preview) your pages actually unfurl with — the questions the catalogue states and refuses to answer.
